...
equations_list = [equations.AdvectionEquation(velocity=np.array([2.0, 2.0]).reshape(2, 1, 1))]
integrators_list = [integrators.rk4]

# Velocity vector (y-velocity, x-velocity)


FINAL_TIME = 0.5        # Enough time for the wave to wrap around periodic boundaries
